      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services/resume-writing" className="hover:text-white">Resume Writing</Link>
              </li>
              <li>
                <Link to="/services/cloud-certifications" className="hover:text-white">Cloud Certifications</Link>
              </li>
              <li>
                <Link to="/services/career-consulting" className="hover:text-white">Career Consulting</Link>
              </li>
              <li>
                <Link to="/services/professional-development" className="hover:text-white">Professional Development</Link>
              </li>
            </ul>
          </div>
