    ...
    <div className="pt-20 bg-slate-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
        ...
        <div className="relative w-full h-96 rounded-3xl overflow-hidden shadow-2xl mb-16 group">
            ...
            <img className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA6UqMI4XhnCYyGFgLdk88SOB8UJsRnt29cfI6M_x-hA-65cuGDMUtW_5mBR3gN4xKu2ioPP8BtdA5CZcggPWTtC0Fovek3oZQ_YDzs7Z29cDKUJmuWq3Wv8bjhjzCcfhgcZYY21u7meomKTErYs5f2q9i1nl8qzJp9a8RBVgoo0NbhtfBSjd0BXoLQGzwoU75676mwANXDvQED6BZgUqMmW-qycKen5aFIF-UtI1IEsZYQT-j2FCAOaTGxsRbK3WEFMaa7yh04tqr2" alt="ERP Dashboard Dashboard" />
