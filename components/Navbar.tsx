      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/" className="text-jha-darkgray hover:text-jha-blue font-medium">
              Home
            </Link>
            <Link href="/services" className="text-jha-darkgray hover:text-jha-blue font-medium">
              Services
            </Link>
            <Link href="/about" className="text-jha-darkgray hover:text-jha-blue font-medium">
              About Us
            </Link>
            <Link href="/testimonials" className="text-jha-darkgray hover:text-jha-blue font-medium">
              Testimonials
            </Link>
            <Link href="/contact">
